...
const validateReason = () => {
  if (!formData.value.reason) {
    ...
    errors.value.reason = 'Reason for joining must be at least 20 characters long.';
  } else {
    errors.value.reason = null;
    // Check if the reason includes the word 'friend'
    formData.value.friendMessage = formData.value.reason.includes('friend') 
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="formData.friendMessage" class="text-success">{{ formData.friendMessage }}</div>
          </div>
